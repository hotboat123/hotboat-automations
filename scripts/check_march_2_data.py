"""
Script para verificar los datos del 2 de marzo en reservas_con_extras
"""
import sys
import os
import asyncio
...
async def check_march_2():
    db = DatabaseManager(os.getenv('DATABASE_URL'))
    await db.initialize()
    
    try:
        # Ver appointments del 2 de marzo
        print("\n" + "="*80)
        print("APPOINTMENTS - 2 MARZO 2026")
        print("="*80 + "\n")
        ...
        appt_query = """
            ...
            WHERE DATE(TO_TIMESTAMP(raw->>'start_date', 'DD/MM/YYYY HH24:MI')) = '2026-03-02'
        ...
        # Ver Informacion Reservas del 2 de marzo
        print("\n" + "="*80)
        print("INFORMACION RESERVAS - 2 MARZO 2026")
        print("="*80 + "\n")
        ...
        ir_query = """
            ...
            WHERE TO_DATE(raw->>'fecha', 'DD/MM/YYYY') = '2026-03-02'
        ...
        for res in reservas:
            ...
            print(f"  Adultos: {res['adultos']}, Ninos: {res['ninos']}")
            print()
        
        # Ver resultado en reservas_con_extras
        print("\n" + "="*80)
        print("RESERVAS_CON_EXTRAS - 2 MARZO 2026")
        print("="*80 + "\n")
        ...
        # Totales
        print(f"\n{'='*80}")
        print(f"TOTALES DEL 2 DE MARZO")
        print(f"{'='*80}")
